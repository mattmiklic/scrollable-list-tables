...
This is a 0.1.5 testing prototype. Plugin compatibility and accessibility feedback are welcome. It is not an official WordPress release.

== Installation ==

1. Go to Plugins > Add Plugin > Upload Plugin in WordPress.
2. Choose scrollable-list-tables-0.1.5.zip, then Install Now.
